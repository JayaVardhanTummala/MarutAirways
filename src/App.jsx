...
function App() {
  ...
  // Check if we're on landing (no search/filter yet)
const isLanding = !searchTerm && !fromFilter && !toFilter;
    ...
    <div className="dashboard">
      <header className="dashboard-header">
        ...
        <div className="user-info">
          <button onClick={() => setDarkMode(!darkMode)} className="darkmode-btn">
      ...
      {activeTab === "flights" && (
        <>
          <div className={`search-filter-wrapper ${isLanding ? "landing" : "active"}`}>
          ...
          <div className={`table-wrapper ${isLanding ? "collapsed" : "expanded"}`}>
...
function SignupForm({ onSignup, onSwitchToLogin }) {
  ...
  const updatePasswordChange = (event) => {
